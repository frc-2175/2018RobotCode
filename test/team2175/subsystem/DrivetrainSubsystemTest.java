...
public class DrivetrainSubsystemTest extends BaseTest {
	...
	public void testUndeadband() {
		assertEquals(-1,
			DrivetrainSubsystem.undeadband(DrivetrainSubsystem.deadband(-1, RobotDriveBase.kDefaultDeadband),
				RobotDriveBase.kDefaultDeadband),
			0.00001);
		assertEquals(-0.5,
			DrivetrainSubsystem.undeadband(DrivetrainSubsystem.deadband(-0.5, RobotDriveBase.kDefaultDeadband),
				RobotDriveBase.kDefaultDeadband),
			0.00001);
		assertEquals(0, DrivetrainSubsystem.undeadband(DrivetrainSubsystem.deadband(0, RobotDriveBase.kDefaultDeadband),
			RobotDriveBase.kDefaultDeadband), 0.00001);
		assertEquals(0.5,
			DrivetrainSubsystem.undeadband(DrivetrainSubsystem.deadband(0.5, RobotDriveBase.kDefaultDeadband),
				RobotDriveBase.kDefaultDeadband),
			0.00001);
		assertEquals(1, DrivetrainSubsystem.undeadband(DrivetrainSubsystem.deadband(1, RobotDriveBase.kDefaultDeadband),
			RobotDriveBase.kDefaultDeadband), 0.00001);
	}
}
