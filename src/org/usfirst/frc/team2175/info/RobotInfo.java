...
public class RobotInfo {
    ...
    private void populate() {
        ...
        put(LEFT_MOTOR_SLAVE2, victor(new WPI_VictorSPX(12)),
                talon(new WPI_TalonSRX(12)));
        put(RIGHT_MOTOR_MASTER, talon(new WPI_TalonSRX(4)),
                talon(new WPI_TalonSRX(4)));
        put(RIGHT_MOTOR_SLAVE1, talon(new WPI_TalonSRX(2)),
                talon(new WPI_TalonSRX(2)));
        put(RIGHT_MOTOR_SLAVE2, victor(new WPI_VictorSPX(3)),
                talon(new WPI_TalonSRX(3)));
        put(ROLLER_BAR_MOTOR, talon(new WPI_TalonSRX(6)),
                talon(new WPI_TalonSRX(6)));
        put(CLIMBER_MASTER, talon(new WPI_TalonSRX(9)),
                talon(new WPI_TalonSRX(9)));
        put(CLIMBER_SLAVE, victor(new WPI_VictorSPX(10)),
                talon(new WPI_TalonSRX(10)));
        put(INTAKE_LEFT_MOTOR, victor(new WPI_VictorSPX(8)),
                talon(new WPI_TalonSRX(8)));
        put(INTAKE_RIGHT_MOTOR, victor(new WPI_VictorSPX(7)),
                talon(new WPI_TalonSRX(7)));
        put(ELEVATOR_MOTOR, victor(new WPI_VictorSPX(5)),
                talon(new WPI_TalonSRX(5)));
        put(INTAKE_PISTON1, () -> new SolenoidWrapper(0, 1),
                () -> new SolenoidWrapper(0, 1));
        put(INTAKE_PISTON2, () -> new SolenoidWrapper(2, 3),
                () -> new SolenoidWrapper(2, 3));
    ...
    private void roboLog(String key, Object obj) {
        if (obj.getClass() == SolenoidWrapper.class) {
            ...
            robotLogger.addLoggable(
                    new LoggableJoystickButton(key, (JoystickButton) obj));
        }
    }
