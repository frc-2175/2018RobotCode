...
public class RobotInfo {
    ...
    public static final String LEFT_MOTOR_MASTER =
            "drivetrain.motor.left.master";
    public static final String LEFT_MOTOR_SLAVE1 =
            "drivetrain.motor.left.slave1";
    public static final String LEFT_MOTOR_SLAVE2 =
            "drivetrain.motor.left.slave2";
    public static final String RIGHT_MOTOR_MASTER =
            "drivetrain.motor.right.master";
    public static final String RIGHT_MOTOR_SLAVE1 =
            "drivetrain.motor.right.slave1";
    public static final String RIGHT_MOTOR_SLAVE2 =
            "drivetrain.motor.right.slave2";
    ...
    public RobotInfo() {
        ...
        info = new HashMap<>();
        botProperties =
                PropertiesLoader.loadProperties("/home/lvuser/bot.properties");
    ...
    private void populate() {
        ...
        put(LEFT_MOTOR_SLAVE1, new WPI_TalonSRX(2), new WPI_TalonSRX(11));
        put(LEFT_MOTOR_SLAVE2, new WPI_TalonSRX(3), new WPI_TalonSRX(12));
        put(RIGHT_MOTOR_MASTER, new WPI_TalonSRX(4), new WPI_TalonSRX(4));
        put(RIGHT_MOTOR_SLAVE1, new WPI_TalonSRX(5), new WPI_TalonSRX(2));
        put(RIGHT_MOTOR_SLAVE2, new WPI_TalonSRX(6), new WPI_TalonSRX(3));
        put(ROLLER_BAR_MOTOR, new WPI_TalonSRX(7), new WPI_TalonSRX(6));
        put(CLIMBER_MASTER, new WPI_TalonSRX(8), new WPI_TalonSRX(9));
        put(CLIMBER_SLAVE, new WPI_TalonSRX(9), new WPI_TalonSRX(10));
        put(INTAKE_LEFT_MOTOR, new WPI_TalonSRX(10), new WPI_TalonSRX(8));
        put(INTAKE_RIGHT_MOTOR, new WPI_TalonSRX(11), new WPI_TalonSRX(7));
        put(ELEVATOR_MOTOR, new WPI_TalonSRX(12), new WPI_TalonSRX(5));
        put(INTAKE_PISTON1, () -> new SolenoidWrapper(1),
                () -> new SolenoidWrapper(1));
        put(INTAKE_PISTON2, () -> new SolenoidWrapper(2),
                () -> new SolenoidWrapper(2));
