...
public class SmartDashboardInfo {
    ...
    public static final String INTAKE_ROLLER_IN_SPEED =
            "intake.roller.in.speed";
    public static final String INTAKE_ROLLER_OUT_SPEED =
            "intake.roller.out.speed";
    ...
    public static final String RUN_ELEVATOR_DOWN_SPEED =
            "run.elevator.down.speed";
    ...
    public void putBooleanArray(String key, boolean[] comp,
            boolean[] practice) {
