...
public class ElevatorSubsystem extends BaseSubsystem {
    ...
    public void runElevatorUp() {
        elevatorMotor.set(smartDashboardInfo
                .getNumber(SmartDashboardInfo.RUN_ELEVATOR_UP_SPEED));
    }

    public void runElevatorDown() {
        elevatorMotor.set(smartDashboardInfo
                .getNumber(SmartDashboardInfo.RUN_ELEVATOR_DOWN_SPEED));
    }

    public void runElevator(double axisValue) {
        elevatorMotor.set(axisValue * smartDashboardInfo
                .getNumber(SmartDashboardInfo.ELEVATOR_MAX_SPEED));
    }
