...
public class IntakeSubsystem extends BaseSubsystem {
    ...
    public void runRollerBarIn() {
        rollerBar.set(smartDashboardInfo
                .getNumber(SmartDashboardInfo.INTAKE_ROLLER_IN_SPEED));
    }

    public void runRollerBarOut() {
        rollerBar.set(smartDashboardInfo
                .getNumber(SmartDashboardInfo.INTAKE_ROLLER_OUT_SPEED));
    }
    ...
    public void runIntakeIn() {
        runRollerBarIn();
        leftIntakeWheel.set(smartDashboardInfo
                .getNumber(SmartDashboardInfo.RUN_INTAKE_IN_SPEED));
        rightIntakeWheel.set(smartDashboardInfo
                .getNumber(SmartDashboardInfo.RUN_INTAKE_IN_SPEED));
    }
    ...
    public void runIntakeOut() {
        runRollerBarOut();
        leftIntakeWheel.set(smartDashboardInfo
                .getNumber(SmartDashboardInfo.RUN_INTAKE_OUT_SPEED));
        rightIntakeWheel.set(smartDashboardInfo
                .getNumber(SmartDashboardInfo.RUN_INTAKE_OUT_SPEED));
    }
