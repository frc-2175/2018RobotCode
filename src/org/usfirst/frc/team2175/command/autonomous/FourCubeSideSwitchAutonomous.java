...
public class FourCubeSideSwitchAutonomous extends BaseCommandGroup {
	...
	public FourCubeSideSwitchAutonomous(boolean left) {
		...
		addSequential(new DriveCurve(HALF_THE_WIDTH_OF_BOT * -sign, 90, 0.9, false, false), 4);
		...
		addSequential(new DriveCurve(HALF_THE_WIDTH_OF_BOT * sign, -90, 0.8, true, true), 4);
		addSequential(new WaitCommand(0.3));
		addParallel(new ElevatorAutonCommand(-0.6, 0, false, false), 1);
		addSequential(new DriveStraightCommand(-0.9, -48, false, false));
		addSequential(new WaitCommand(0.2));
		...
		addParallel(new MoveIntakeUpCommand());
		addSequential(new DriveStraightCommand(-1, 20, false, false));
		addSequential(new TurnInPlaceCommand(-10, 0.9, false, false));
		addSequential(new DriveStraightCommand(0.8, 132, false, false));
