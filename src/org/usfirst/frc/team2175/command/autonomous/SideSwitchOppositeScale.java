...
public class SideSwitchOppositeScale extends BaseCommandGroup {
	...
	public SideSwitchOppositeScale(boolean left) {
		...
		addSequential(new DriveCurve(4 * HALF_THE_WIDTH_OF_BOT * sign, -180, 1, false, false), 4);
